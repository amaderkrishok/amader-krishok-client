...
export function VendorBanner() {
	return (
		<div className='relative overflow-hidden bg-gradient-to-r from-[#4A5E3A] via-[#3D4F2E] to-[#4A5E3A] rounded-2xl p-6 sm:p-8 mb-8 shadow-xl border border-white/15 group'>
			{/* Decorative elements */}
