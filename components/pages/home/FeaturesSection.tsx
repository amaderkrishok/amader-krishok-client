...
export default function FeaturesSection() {
    ...
    return (
        <section ref={sectionRef} className="w-full px-4 sm:px-6 lg:px-[10%] xl:px-[18.5%] 2xl:px-12 py-24 bg-[#FDFBF7] text-[#2D331F] relative overflow-hidden selection:bg-[#EAB308] selection:text-[#2D331F] border-t border-gray-200/60">
