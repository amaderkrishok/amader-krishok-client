...
export function TextRotatorSection() {
  return (
    <section className="w-full px-4 sm:px-6 lg:px-[10%] xl:px-[18.5%] 2xl:px-12 bg-[#FDFBF7] py-16 sm:py-20 lg:py-24 border-y border-gray-200/80 relative overflow-hidden selection:bg-[#EAB308] selection:text-[#2D331F]">
