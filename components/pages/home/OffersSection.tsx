...
export function OffersSection() {
  ...
  return (
    <section className="w-full px-4 sm:px-6 lg:px-8 xl:px-20 2xl:px-12 py-16 sm:py-20 bg-[#FAF9F3] text-[#172033] relative overflow-hidden border-b border-gray-200/60">
