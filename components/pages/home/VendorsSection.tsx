...
export function VendorsSection() {
  ...
  return (
    <section className="w-full px-4 sm:px-6 lg:px-[10%] xl:px-[18.5%] 2xl:px-12 py-16 sm:py-20 bg-[#F5F3EA] text-[#172033] relative overflow-hidden border-b border-gray-200/80">
