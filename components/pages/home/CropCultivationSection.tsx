...
export function CropCultivationSection() {
  ...
  return (
    <section className="w-full px-4 sm:px-6 lg:px-[10%] xl:px-[18.5%] 2xl:px-12 py-16 sm:py-24 bg-gradient-to-b from-[#FAF9F3] via-white to-[#FAF9F3] text-[#172033] relative overflow-hidden border-b border-gray-200/60">
