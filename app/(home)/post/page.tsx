...
const PostsPageContent = () => {
  ...
  return (
		<div className='min-h-screen bg-[#F8FAF7] text-[#172018] font-sans antialiased'>
			...
			{/* MAIN CONTAINER */}
			<div className='w-full px-4 sm:px-6 lg:px-[10%] xl:px-[18.5%] 2xl:px-12 py-8 sm:py-12'>
			...
			<section className='w-full px-4 sm:px-6 lg:px-[10%] xl:px-[18.5%] 2xl:px-12 py-12'>
				<div className='max-w-7xl mx-auto'>
