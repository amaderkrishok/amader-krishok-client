...
function CropCultivationContent() {
	...
	return (
		<div className='min-h-screen bg-[#FDFBF7] text-[#2D331F] selection:bg-[#EAB308] selection:text-[#2D331F]'>
			...
			{/* --- HERO SECTION --- */}
			<section className='relative bg-[#37462A] text-white pt-28 sm:pt-36 pb-16 sm:pb-20 w-full px-4 sm:px-6 lg:px-[10%] xl:px-[18.5%] 2xl:px-12 overflow-hidden'>
			...
			<div className='w-full px-4 sm:px-6 lg:px-[10%] xl:px-[18.5%] 2xl:px-12 -mt-6 relative z-20'>
