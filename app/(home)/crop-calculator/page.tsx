...
export default function CropCalculatorPage() {
	...
	return (
		<div className='min-h-screen bg-[#FDFBF7] text-[#2D331F] selection:bg-[#FBBF24] selection:text-[#2D331F] font-sans'>
			...
			{/* INFO CARDS SECTION                                   */}
			{/* ==================================================== */}
			<section className='w-full px-4 sm:px-6 lg:px-[10%] xl:px-[18.5%] 2xl:px-12 mt-16 mb-16'>
				<div className='max-w-7xl mx-auto'>
			...
			{/* HELP SECTION                                         */}
			{/* ==================================================== */}
			<section className='w-full px-4 sm:px-6 lg:px-[10%] xl:px-[18.5%] 2xl:px-12 mb-20'>
				<div className='max-w-7xl mx-auto'>
					<motion.div
						initial={{ opacity: 0, y: 30 }}
						whileInView={{ opacity: 1, y: 0 }}
